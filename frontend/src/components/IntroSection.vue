<template>
  <v-container
    class="introduction-section pb-16"
    fluid
    ...
    <v-row justify="center">
      <v-col cols="12" md="10" class="pt-10">
        <p style="font-weight: 600; font-size: 1.4rem">
          The climate is changing, and so is the vegetation at Berlin’s beloved
          Tempelhofer Feld.
        </p>
        <p class="intro-text pt-10">
          Climate change affects the entire globe, but its impacts are also
          evident on a smaller, local scale. Tempelhofer Feld, a unique urban
          oasis in Berlin, serves as an example of this. Once an airport in the
          middle of the city, this vast field has transformed into a public
          park, offering a fascinating case study of how urban green spaces
          evolve and respond to changes in climate.
        </p>
        <p class="intro-text pt-6">
          We analyzed the microclimate of this unique area by deriving
          vegetation indices from high-resolution satellite imagery and
          utilizing long-term in-vitro sensors.
        </p>
        <p class="intro-text pt-6">Check out the results yourself below.</p>
        ...
        <v-row justify="center" align="center" class="pt-10" dense>
          <v-col
            cols="12"
            md="5"
            class="d-flex flex-column align-items-center my-6 mx-4"
          >
            <img
            ...
            />
            <p class="caption">
              <a href="https://www.flickr.com/people/29949005@N02/"
                >© Berlin-Knipser</a
              >
            </p>
          </v-col>
